<%@page import="com.nhathuy.utils.HuyUtil"%>
					...
					<div class="row carousel-holder">
						...
						<div class="col-md-8">
							<div class="panel panel-default">
								<div class="panel-heading" style="text-align: center; font-size: 170%;"><b>Thêm mới loại bệnh</b></div>
								<div class="panel-body">
									<form method="post" action="ThemLoaiBenhController">
										<div>
											<label>Mã bệnh</label>
											<input name="txtMaBenh" type="text" class="form-control" placeholder="Mã bệnh">
										</div> <br>
										<div>
											<label>Tên loại bệnh</label>
											<input name="txtTenBenh" type="text" class="form-control" placeholder="Tên loại bệnh">
										</div> <br>
										<div>
											<label>Mô tả ngắn gọn</label>
											<textarea name="txtMoTa" rows="3" class="form-control" placeholder="Mô tả ngắn gọn"></textarea>
										</div> <br>
										<button type="submit" class="btn btn-success form-control">Thêm mới</button>
										<span><%= HuyUtil.getString(request.getAttribute("msgThemBenh")) %></span>
									</form>
								</div>
							</div>
						</div>
